...
from game_agent import aggressive_heuristic, defensive_heuristic, maximizing_win_chances_heuristic, minimizing_losing_chances_heuristic, chances_heuristic, weighted_chances_heuristic, weighted_chances_heuristic_2, custom_score,custom_score_open
...
def main():
    ...
    test_agents = [
                   ...
                   # here is the where to add
                   Agent(CustomPlayer(score_fn=custom_score,**CUSTOM_ARGS),"Customized Score"),
                   Agent(CustomPlayer(score_fn=custom_score_open,**CUSTOM_ARGS),"Cuztomized Score 2nd"),
