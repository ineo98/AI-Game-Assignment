...
import pacman.controllers.examples.MinimaxPacman;
import pacman.controllers.examples.NNPacman;
...
import pacman.controllers.examples.Qlearning;
...
{	
	...
	public static void main(String[] args)
	{
		...
		Executor exec=new Executor();
                exec.runExperiment(new NNPacman(GenAlg.serializeDataIn()), new Legacy2TheReckoning(),numTrials);
