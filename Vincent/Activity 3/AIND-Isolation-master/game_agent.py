...
def my_heuristic_function(game, player):
    ...
    # m = current_moves / (board_size/2)
    # if m <= 0.5:
    #     return my_moves - opponent_moves * 2
    # else:
    #     return my_moves * 2 - opponent_moves
    return my_moves - opponent_moves * 2 + A
    # return (my_moves * 2)  * (current_moves / board_size) - opponent_moves
